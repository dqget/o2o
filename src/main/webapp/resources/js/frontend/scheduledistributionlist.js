$(function () {
    ...
    const scheduleDistributionListUrl = "/o2o/frontend/getschedule?scheduleId=" + scheduleId;
    //商品下架的URL
    ...
    $('.schedule-distribution-wrap').on('click', 'a', function (e) {
        ...
        location.href = '/o2o/frontend/distributionoperation?scheduleDistributionId=' + scheduleDistributionId;
    });
});
